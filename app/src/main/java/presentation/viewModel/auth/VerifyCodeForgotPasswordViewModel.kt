...
class VerifyCodeForgotPasswordViewModel : ViewModel() {
    private val userRepository = UserRepositoryImpl()

    var uiState = mutableStateOf(VerifyCodeForgotPasswordUiState())
        private set
    ...
    fun verifyForgotPasswordCode(email: String, code: String) {
        ...
        viewModelScope.launch {
            userRepository.verifyCodeForgotPassword(email, code)
                .onSuccess {
                    uiState.value = uiState.value.copy(
                        isLoading = false,
...
data class VerifyCodeForgotPasswordUiState(
